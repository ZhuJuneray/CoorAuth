...
def pin_str_to_pattern(pin_str):
    """ Convert a PIN string to a pattern of connected points. """
    grid_size = 3
    return [(int(pin) % grid_size, int(pin) // grid_size) for pin in pin_str]
...
a = '6783'
b = '67843'
pattern1 = pin_str_to_pattern(a)
pattern2 = pin_str_to_pattern(b)
