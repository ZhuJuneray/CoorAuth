...
drawer = Drawer(filepath="src/data_own_3days.json", size_list=[3], pin_list=range(13,19), rotdir = os.path.join(os.getcwd(), 'data'), default_authentications_per_person=7) # todo: 从json里读取num_range
